...
def test_add_contact(app):
        ...
        app.contact.create(Contact(firstname="ff", lastname="ff", middlename="ff", nickname="ff", company="ff", address="ff", home="ff", mobile="33", work="44", fax="44", email="1@mail.ru", email2="2@mail.ru",
...
def test_add_empty_contact(app):
        app.session.login(username="admin", password="secret")
        app.contact.create(Contact(firstname="", lastname="", middlename="", nickname="", company="", address="", home="", mobile="", work="", fax="", email="", email2="",
